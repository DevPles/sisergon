...
const LandingPage = () => {
  ...
  const heroVideos = ['/videos/hero-1.mp4', '/__l5e/assets-v1/c8c03f81-afc2-400c-a7b3-541886969034/hero-2-v2.mp4', '/__l5e/assets-v1/7cab6c3a-f134-4fe5-b2f8-11f1ffe4cfe5/hero-3-v2.mp4']; // video carousel
