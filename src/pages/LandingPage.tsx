...
const services: ServiceOption[] = [
  { id: 'aep', label: 'Avaliação Ergonômica Preliminar (AEP)', description: 'Identificação inicial de riscos ergonômicos no ambiente de trabalho', basePrice: 800, category: 'essential', avgLawsuitCost: 60000, riskReduction: 0.60, riskContext: 'Condenações por LER/DORT no TST chegam a R$ 60 mil por caso.', jurisprudencia: 'https://www.jusbrasil.com.br/jurisprudencia/trt-17/4477738358/inteiro-teor-4480773450' },
  { id: 'aet', label: 'Análise Ergonômica do Trabalho (AET)', description: 'Análise aprofundada com recomendações técnicas detalhadas', basePrice: 1500, category: 'essential', avgLawsuitCost: 80000, riskReduction: 0.75, riskContext: 'Perícias sem laudo técnico geram condenações entre R$ 50 mil e R$ 100 mil.', jurisprudencia: 'https://www.jusbrasil.com.br/jurisprudencia/trt-9/5458602443/inteiro-teor-5458602446' },
  { id: 'pcmso', label: 'Gestão PCMSO Integrada', description: 'Controle de exames médicos, ASOs e cronogramas de saúde', basePrice: 1200, category: 'essential', avgLawsuitCost: 25000, riskReduction: 0.70, riskContext: 'Empresas autuadas por SST pagaram em média R$ 18,4 mil em multas em 2025.', jurisprudencia: 'https://www.jusbrasil.com.br/jurisprudencia/trf-5/5459440591/inteiro-teor-5459440601' },
  { id: 'psicossocial', label: 'Avaliação de Riscos Psicossociais', description: 'Mapeamento de fatores como estresse, assédio e carga mental', basePrice: 2000, category: 'advanced', avgLawsuitCost: 100000, riskReduction: 0.65, riskContext: 'Ações por burnout cresceram 14,5% e somam R$ 3,75 bilhões em impacto.', jurisprudencia: 'https://www.jusbrasil.com.br/jurisprudencia/trt-15/5401649145/inteiro-teor-5401649148' },
  { id: 'dashboard', label: 'Dashboard Executivo e Indicadores', description: 'Painel visual com KPIs, tendências e relatórios para gestão', basePrice: 900, category: 'advanced', avgLawsuitCost: 25000, riskReduction: 0.50, riskContext: 'Grandes empresas reincidentes pagam até R$ 25 mil por autuação.', jurisprudencia: 'https://www.jusbrasil.com.br/jurisprudencia/trt-1/4106937082/inteiro-teor-4106937089' },
  { id: 'alertas', label: 'Alertas e Notificações Inteligentes', description: 'Avisos automáticos de vencimentos, prazos e ações pendentes', basePrice: 600, category: 'advanced', avgLawsuitCost: 18000, riskReduction: 0.55, riskContext: 'Multas por documentos vencidos chegam a R$ 12,6 mil para grandes empresas.', jurisprudencia: 'https://www.jusbrasil.com.br/jurisprudencia/trt-9/2864831337/inteiro-teor-2864831350' },
  { id: 'planos_acao', label: 'Planos de Ação Automatizados', description: 'Geração automática de planos corretivos com rastreabilidade', basePrice: 1100, category: 'premium', avgLawsuitCost: 50000, riskReduction: 0.70, riskContext: 'PGR sem plano de ação gera multa de até R$ 12,6 mil, dobrando em reincidência.', jurisprudencia: 'https://www.jusbrasil.com.br/jurisprudencia/trt-15/3358037786/inteiro-teor-3358037792' },
  { id: 'multiempresa', label: 'Gestão Multi-empresa', description: 'Gerencie diversas empresas em um único painel centralizado', basePrice: 1800, category: 'premium', avgLawsuitCost: 80000, riskReduction: 0.60, riskContext: 'Cada filial é fiscalizada independentemente. Multas multiplicam a exposição.', jurisprudencia: 'https://www.jusbrasil.com.br/jurisprudencia/trt-2/4443901762' },
  { id: 'suporte', label: 'Suporte Prioritário e Personalização', description: 'Atendimento dedicado, treinamentos e configurações sob medida', basePrice: 1500, category: 'premium', avgLawsuitCost: 25000, riskReduction: 0.45, riskContext: 'Treinamentos obrigatórios não realizados geram autuações.', jurisprudencia: 'https://www.jusbrasil.com.br/jurisprudencia/trt-3/1463930631/inteiro-teor-1463930633' },
];
