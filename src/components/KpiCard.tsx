...
export const KpiCard = ({ label, value, subtitle, variant = 'default', className }: KpiCardProps) => (
  <Card className={cn(
    "relative overflow-hidden group hover:shadow-xl transition-all duration-300 hover:bg-[#1E40AF] cursor-default border-primary/10",
    className
  )}>
    <CardContent className="p-5">
      <div className="transition-all duration-300 group-hover:scale-110">
        <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider group-hover:text-blue-50 transition-colors duration-300">
          {label}
        </p>
        <p className={cn(
